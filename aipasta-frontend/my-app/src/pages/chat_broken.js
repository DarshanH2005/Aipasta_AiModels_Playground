        ...
        try {
          await streamModelResponse(
            ...
            (finalResponse) => {
              ...
              // The final chunk should already be delivered via onChunk with isComplete=true.
              // Avoid calling updateResponse here to prevent duplicated final text.
            ...
            (error) => {
              ...
              // Let the error handler set the response error; avoid a separate complete call
        ...
        <Sidebar open={open} setOpen={setOpen} animate={true} locked={locked} setLocked={setLocked}>
          <SidebarBody className="justify-between gap-4 h-full">
            <div className="flex flex-col flex-1 min-h-0 overflow-hidden">
              ...
              {/* User Credits Display - Only show when open or locked */}
              {(open || locked) && (
                <div className="flex-shrink-0 min-w-0 mb-4">
                  <TokenDisplay 
                    user={user} 
